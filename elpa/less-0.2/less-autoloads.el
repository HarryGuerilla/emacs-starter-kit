...
;;;;;;  less-minor-mode) "less" "less.el" (19502 49568))
;;; Generated autoloads from less.el

(autoload (quote less-minor-mode) "less" "\
...
(autoload (quote auto-less-minor-mode) "less" "\
Auto enter `less-minor-mode' when visiting read-only files. You can
add this to `find-file-hooks'.

\(fn)" nil nil)

(autoload (quote less-minor-mode-on) "less" "\
Turn on `less-minor-mode'.

\(fn)" nil nil)

(autoload (quote less-minor-mode-off) "less" "\
...
;;;***

;;;### (autoloads nil nil ("less-pkg.el") (19502 49568 646730))
