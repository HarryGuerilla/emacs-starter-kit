...
;;;;;;  "smart-operator.el" (19502 49759))
;;; Generated autoloads from smart-operator.el

(autoload (quote smart-insert-operator) "smart-operator" "\
...
(autoload (quote smart-beautify-operator) "smart-operator" "\
...
(autoload (quote smart-insert-operator-hook) "smart-operator" "\
...
(autoload (quote smart-insert-c-style-<) "smart-operator" "\
Insert `<>' or ` < ' smartly.
...
;;;***

;;;### (autoloads nil nil ("smart-operator-pkg.el") (19502 49759
;;;;;;  34580))
