...
;;;;;;  "emms-cache" "emms-cache.el" (19502 49250))
...
;;;;;;  "emms-lyrics" "emms-lyrics.el" (19502 49249))
...
;;;;;;  "emms-mode-line" "emms-mode-line.el" (19502 49250))
...
(autoload (quote emms-mode-line-toggle) "emms-mode-line" "\
...
;;;;;;  "emms-player-mpd" "emms-player-mpd.el" (19502 49251))
...
;;;;;;  "emms-playing-time" "emms-playing-time.el" (19502 49250))
;;; Generated autoloads from emms-playing-time.el

(autoload (quote emms-playing-time-enable-display) "emms-playing-time" "\
Display playing time on mode line.

\(fn)" t nil)

(autoload (quote emms-playing-time-disable-display) "emms-playing-time" "\
...
;;;;;;  "emms-score" "emms-score.el" (19502 49250))
...
;;;;;;  emms-minimalistic) "emms-setup" "emms-setup.el" (19502 49251))
...
;;;;;;  "emms-source-file" "emms-source-file.el" (19502 49251))
...
;;;;;;  "emms-tag-editor" "emms-tag-editor.el" (19502 49250))
;;; Generated autoloads from emms-tag-editor.el

(autoload (quote emms-tag-editor-guess-tag-filename) "emms-tag-editor" "\
...
(autoload (quote emms-tag-editor-compile-pattern) "emms-tag-editor" "\
...
;;;;;;  emms-volume-raise) "emms-volume" "emms-volume.el" (19502
;;;;;;  49250))
;;; Generated autoloads from emms-volume.el

(autoload (quote emms-volume-raise) "emms-volume" "\
Raise the speaker volume.

\(fn)" t nil)

(autoload (quote emms-volume-lower) "emms-volume" "\
Lower the speaker volume.

\(fn)" t nil)

(autoload (quote emms-volume-mode-plus) "emms-volume" "\
Raise volume and enable or extend the `emms-volume-minor-mode' timeout.

\(fn)" t nil)

(autoload (quote emms-volume-mode-minus) "emms-volume" "\
...
;;;;;;  "emms-volume-amixer.el" (19502 49251))
;;; Generated autoloads from emms-volume-amixer.el

(autoload (quote emms-volume-amixer-change) "emms-volume-amixer" "\
...
;;;***

;;;### (autoloads (tq-create) "tq" "tq.el" (19502 49251))
...
;;;;;;  "emms-url.el" "emms.el" "jack.el" "later-do.el") (19502 49251
;;;;;;  356242))
