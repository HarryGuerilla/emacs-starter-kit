...
;;;;;;  jp-remove-generated-files) "jimb-patch" "jimb-patch.el" (19502
;;;;;;  49563))
;;; Generated autoloads from jimb-patch.el

(autoload (quote jp-remove-generated-files) "jimb-patch" "\
...
(autoload (quote jp-extract-ChangeLog-entries) "jimb-patch" "\
Turn ChangeLog patch entries into ChangeLog entries at the top of the file.

\(fn)" t nil)

(autoload (quote jp-remove-fake-darcs-parents) "jimb-patch" "\
...
(autoload (quote jp-clean-patch) "jimb-patch" "\
...
(autoload (quote jp-insert-file) "jimb-patch" "\
Insert FILE and clean it using `jp-clean-patch'.

\(fn FILE)" t nil)

(autoload (quote jp-insert-buffer) "jimb-patch" "\
...
;;;***

;;;### (autoloads nil nil ("jimb-patch-pkg.el") (19502 49563 981019))
