...
;;;;;;  "test-case-mode.el" (19502 49760))
;;; Generated autoloads from test-case-mode.el

(autoload (quote test-case-mode) "test-case-mode" "\
...
(autoload (quote enable-test-case-mode-if-test) "test-case-mode" "\
Turns on ``test-case-mode'' if this buffer is a recognized test.

\(fn)" nil nil)
(add-hook 'find-file-hook 'enable-test-case-mode-if-test)

(autoload (quote test-case-find-all-tests) "test-case-mode" "\
Find all test cases in DIRECTORY.

\(fn DIRECTORY)" t nil)

(autoload (quote test-case-compilation-finish-run-all) "test-case-mode" "\
...
;;;***

;;;### (autoloads nil nil ("test-case-mode-pkg.el") (19502 49760
;;;;;;  860406))
